// OpeningBook.js
// Compact offline opening book with the top replies for the first four plies
// (about two moves per side). Keys are SAN sequences joined by spaces; values
// are arrays of [SAN, weight].

import BOOK from './openingBook.json';
